...
const PaymentDialog = ({ visible, onTouchOutside, onPressPayPal, onPressPayTaps }) => {
  const renderFooter = () => {
    return (
      <DialogFooter>
  ...
  return (
    <Dialog
      ...
      dialogTitle={<DialogTitle style={{ backgroundColor: "#02aab0" }} align="center" title={I18n.t('Choosethetypeofpayment')} />}
