...
export default class FootballField extends Component {
  constructor(props) {
    super(props);
    this.state = { home: props.home, away: props.away };
  }
      ...
      <View style={styles.container}>
        ...
        >
          <View style={{ backgroundColor: "rgba(52, 52, 52, 0.45)", flex: 1 }}>
            <View style={{ flex: 1, backgroundColor: "rgba(204, 70, 43, 0)" }}>
              <View style={{ flexDirection: "row" }}>
                <Text style={[styles.text, { marginLeft: 20 }]}>{this.state.home.module}</Text>
                <Text style={[styles.text, { position: "absolute", right: 20 }]}>{this.state.home.name}</Text>
              </View>
                        ...
                        {this.state.home.home_team_events.map(
                          (el, z) =>
                            ...
                            el.type_of_event == "yellow-card" && (
                              <Image
                                key={"hy" + z}
                                source={require("../../assets/card-yellow.png")}
                                style={{ width: 12, height: 15, position: "absolute", left: -12 }}
                              />
                            )
                        )}
                        {this.state.home.home_team_events.map(
                          (el, z) =>
                            ...
                            el.type_of_event == "red-card" && (
                              <Image
                                key={"hr" + z}
                                source={require("../../assets/card-red.png")}
                                style={{ width: 12, height: 15, position: "absolute", left: -12 }}
                              />
                            )
                        )}
                          ...
                          (el, z) =>
                            ...
                            el.type_of_event == "substitution-in" && (
                              <Image
                                ...
                                style={{ width: 12, height: 12, position: "absolute", right: -14 }}
                              />
                            )
                        )}
                      </View>
            ...
            <View style={{ flex: 1, backgroundColor: "rgba(43, 99, 204, 0)", paddingTop: 55 }}>
              ...
              <View style={{ flexDirection: "row" }}>
                <Text style={[styles.text, { marginLeft: 20 }]}>{this.state.away.module}</Text>
                <Text style={[styles.text, { position: "absolute", right: 20 }]}>{this.state.away.name}</Text>
              </View>
            </View>
          </View>
        </ImageBackground>
