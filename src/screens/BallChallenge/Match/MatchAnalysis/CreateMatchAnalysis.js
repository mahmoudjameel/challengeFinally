...
const CreateMatchAnalysis = ({ route, navigation }) => {
  ...
  useEffect(() => {
    (async () => {
      ...
      setBalls(parseInt(b.createMatchAnalysis || 1));
      setUser(user);
    })();
  }, []);
        ...
        { text: I18n.t('cancel'), style: "cancel" },
        {
          ...
          onPress: async () => {
            ...
            if (balls <= user.goldBalls) {
              const response = await Fire.addMatchAnalysisContent(matchId, {
                title: title,
                type: "video/mp4",
                imageVideo: video,
                rating: 0,
...
export default CreateMatchAnalysis;
