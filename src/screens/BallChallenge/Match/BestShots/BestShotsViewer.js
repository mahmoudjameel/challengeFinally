...
const BestShotViewer = ({ route, navigation }) => {
  ...
  useEffect(() => {
    ...
    const subscriber = Fire.getBestShotContent(matchId, itemData, (content) => {
  ...
  const ratingCompleted = async (rating) => {
    ...
    await Fire.updateBestShotContent(matchId, itemData, { rating: ratings, reviews: review });
  };

  //Add Comment
  const addComment = async () => {
    setloading((loading) => true);
    await Fire.addCommentToBestShotContent(matchId, itemData, comment);
